...
- [moznion/gonstructor](https://github.com/moznion/gonstructor) ([v0.5.1](https://github.com/moznion/gonstructor/releases/tag/v0.5.1), 5 days ago) - A command-line tool to generate a constructor for the struct.
