...
- [kkharji/sqlite.lua](https://github.com/kkharji/sqlite.lua) - SQLite LuaJIT binding with a very simple api. (2 days ago)
...
- [WebDevSimplified/permission-system](https://github.com/WebDevSimplified/permission-system) -  (4 days ago)

#### 🔭 Latest releases I've contributed to

- [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ([v0.0.14](https://github.com/yetone/avante.nvim/releases/tag/v0.0.14), 4 days ago) - Use your Neovim like using Cursor AI IDE!
- [LintaoAmons/bookmarks.nvim](https://github.com/LintaoAmons/bookmarks.nvim) ([v2.0.2](https://github.com/LintaoAmons/bookmarks.nvim/releases/tag/v2.0.2), 4 days ago) - Persistent bookmarks: powerful but simple (one shortcut to add, rename, and remove bookmark)
