...
- [Ramilito/kubectl.nvim](https://github.com/Ramilito/kubectl.nvim) ([v1.5.0](https://github.com/Ramilito/kubectl.nvim/releases/tag/v1.5.0), today) - ⎈ Streamline your Kubernetes management within Neovim—control and monitor your cluster seamlessly, all without leaving your coding environment.
- [LintaoAmons/bookmarks.nvim](https://github.com/LintaoAmons/bookmarks.nvim) ([v2.6.1](https://github.com/LintaoAmons/bookmarks.nvim/releases/tag/v2.6.1), 4 days ago) - Persistent bookmarks: hard disk of your thoughts
