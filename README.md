...
- [Ramilito/kubectl.nvim](https://github.com/Ramilito/kubectl.nvim) ([v2.1.0](https://github.com/Ramilito/kubectl.nvim/releases/tag/v2.1.0), today) - ⎈ Streamline your Kubernetes management within Neovim—control and monitor your cluster seamlessly, all without leaving your coding environment.
