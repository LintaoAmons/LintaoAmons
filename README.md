...
- [高级 YAML 技巧：锚点与合并](https://oatnil.top/blogs/2025/07/25/advanced-yaml-techniques-anchors-merge) (4 days ago)

- [Docker vs Kubernetes 端口处理机制完全解析](https://oatnil.top/blogs/2025/07/25/docker-kubernetes-port-handling) (4 days ago)

- [解决 Docker overlay2 目录占用大量磁盘空间的问题](https://oatnil.top/blogs/2025/07/24/docker-overlay2-clean-up) (5 days ago)
...
- [Ramilito/kubectl.nvim](https://github.com/Ramilito/kubectl.nvim) ([v2.0.22](https://github.com/Ramilito/kubectl.nvim/releases/tag/v2.0.22), 1 day ago) - ⎈ Streamline your Kubernetes management within Neovim—control and monitor your cluster seamlessly, all without leaving your coding environment.
