...
- [Ramilito/kubectl.nvim](https://github.com/Ramilito/kubectl.nvim) ([v2.4.8](https://github.com/Ramilito/kubectl.nvim/releases/tag/v2.4.8), today) - ⎈ Streamline your Kubernetes management within Neovim—control and monitor your cluster seamlessly, all without leaving your coding environment.
