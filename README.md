...
- [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ([v0.0.12](https://github.com/yetone/avante.nvim/releases/tag/v0.0.12), 3 days ago) - Use your Neovim like using Cursor AI IDE!
- [LintaoAmons/bookmarks.nvim](https://github.com/LintaoAmons/bookmarks.nvim) ([v1.4.2](https://github.com/LintaoAmons/bookmarks.nvim/releases/tag/v1.4.2), 6 days ago) - Persistent bookmarks: powerful but simple (one shortcut to add, rename, and remove bookmark)
